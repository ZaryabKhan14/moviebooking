        ...
        <div class="w3l-breadcrumbs">
            <nav id="breadcrumbs" class="breadcrumbs">
                <div class="container page-wrapper">
                    <a href="index.html">Home</a> » <span class="breadcrumb_last" aria-current="page">Manage Account</span>
                </div>
            </nav>
        </div>
        <!--//breadcrumbs -->
        ...
        <section class="w3l-contact-1">
            <div class="contacts-9 py-5">
                <div class="container py-lg-4">
                    ...
                    <h1 class="sub-title text-center" style="font-size:50px;">Manage Account</h1>
