...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/02-07-2020/proshowz-liberty-demo_Free/1734035036/web/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Jun 2021 16:35:58 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>ProShowz a Entertainment Category Bootstrap Responsive Website Template | Contact :: W3layouts</title>
    <!-- Template CSS -->
        ...
        <section class="w3l-contact-1">
            <div class="contacts-9 py-5">
                <div class="container py-lg-4">
                    ...
                    <h1 class="sub-title text-center" style="font-size:50px;">Contact Us</h1>
                        <h3 class="hny-title mb-0" style="margin-top:40px;">Leave a Message</h3>
                            ...
                            <form method="post" class="formhny-sec">
                                ...
                                <div class="form-grids">
                                    <div class="form-input">
                                        <input type="text"  id="c_name" placeholder="Enter your name " required="" />
                                    </div>
                                    <div class="form-input">
                                ...
                                <div class="form-input mt-4">
                                    <textarea id="query" placeholder="Type your query here" required=""></textarea>
                                </div>
                                <div class="submithny text-right mt-4">
                                <!-- <input type="button" value="submit Message" id="submit" class="read-button"> -->
                                <button type="button" class="btn read-button" id="submit">Submit Message</button>
                                </div>
